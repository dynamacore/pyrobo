...
if __name__ == "__main__":
    ...
    link2 = robotics.Transform(
        0.1, -1.5, -0.5, 0, 0, parent="base_link", child="link2", name="bTo2"
    )
    link3 = robotics.Transform(
        0.5, 0.5, -0.2, np.pi, 0, 0, parent="link1", child="link3", name="3To1"
    )
    link4 = robotics.Transform(
        0.0, 0.2, 0.5, 0.0, -np.pi / 4, 0, parent="link3", child="link4", name="4To3"
    )
    link5 = robotics.Transform(
        0.0, -0.2, 0.5, 0.0, -np.pi / 4, 0, parent="link3", child="link5", name="5To3"
    )
