...
class ExtendedKalmanFilter:
    ...
    def predict(self, nonlinear_motion_model: Callable[[np.ndarray], np.ndarray]):
        ...
        """
        self.state, self.covariance = self.__predict_extended(
            self.state, self.covariance, nonlinear_motion_model, self.process_noise_cov
        )
    ...
    def __predict_extended(
        ...
        nonlinear_motion_model: Union[
            Callable[[np.ndarray], np.ndarray], Callable[[np.ndarray, list], np.ndarray]
        ],
