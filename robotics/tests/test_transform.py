...
def test_equality_nodes():
	...
	'''
	one = robotics.Transform(0.32, 0.67, 0.123, 0.56, np.pi/2, 23.4, parent="base", child="nase", name="base2nase")
	two = robotics.Transform(0.32, 0.67, 0.123, 0.56, np.pi/2, 23.4, parent="base", child="nase", name="base2nase")
	assert one == two
	# change parent name
	two.parent = "flase"
	assert not one == two
