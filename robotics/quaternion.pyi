...
class Quaternion:
	...
	def plot(self, detached:bool=False, axis_obj:Axes=None, rgb_xyz:Tuple[str, str, str]=['r', 'g', 'b'], xlim:Tuple[int, int]=[-2, 2], ylim:Tuple[int, int]=[-2, 2], zlim:Tuple[int, int]=[-2, 2], scale_factor:float=1.0, view_angle:Tuple[float, float]=None) -> None: 
		"""
